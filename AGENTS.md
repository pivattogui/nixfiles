...
This is a personal nix-darwin configuration repository managing macOS environments using Nix flakes, nix-darwin, and Home Manager. It currently supports one host (`moka`) with per-user settings and shared modules.
